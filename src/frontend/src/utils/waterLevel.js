...
export function waterText(stage) {
  switch (stage) {
    case WATER_STAGES.CRIT: return '심각 (90% ⇡)'
    case WATER_STAGES.WARN: return '경계 (80% ⇡)'
    case WATER_STAGES.CAUTION: return '주의 (70% ⇡)'
    case WATER_STAGES.OK: return '정상 (<70%)'
...
export function fillColorByStage(stage) {
  switch (stage) {
    case WATER_STAGES.CRIT: return 'rgba(255, 77, 79, .90)'
    case WATER_STAGES.WARN: return 'rgba(255, 159, 26, .90)'
    case WATER_STAGES.CAUTION: return 'rgba(247, 201, 72, .90)'
    case WATER_STAGES.OK: return 'rgba(39, 196, 107, .90)'
    default: return 'rgba(154, 167, 183, .85)'
  }
}
